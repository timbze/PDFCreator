...
namespace SetupHelper
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (clp.HasArgument("FileExtensions"))
            {
                ...
                try
                {
                    ...
                    {
                        case "Add": MaybeInvokeWow6432(AddExplorerIntegration); break;
                        case "Remove": MaybeInvokeWow6432(RemoveExplorerIntegration); break;
            ...
            if (clp.HasArgument("ComInterface"))
            {
                ...
                try
                {
                    ...
                    {
                        case "Register": MaybeInvokeWow6432(RegisterComInterface); break;
                        case "Unregister": MaybeInvokeWow6432(UnregisterComInterface); break;
                        default: showUsage = true; break;
                    }
                }
                catch (Exception ex)
        ...
        {
            CallRegAsmForShell(wow6432, "PDFCreator.exe", "/codebase /tlb");
        }

        private static void UnregisterComInterface(bool wow6432)
        {
            CallRegAsmForShell(wow6432, "PDFCreator.exe", "/unregister");
        }
