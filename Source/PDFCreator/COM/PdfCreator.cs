...
namespace pdfforge.PDFCreator.COM
{
    ...
    public class PdfCreatorObj : IPDFCreator
    {
        ...
        {
            get { return PipeServer.SessionServerInstanceRunning(ThreadManager.PipeName); }
        }
        ...
        /// <param name="allowDefaultPrinterSwitch">If true, the default printer will be temporally changed,
