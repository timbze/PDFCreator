...
namespace PDFCreator.Core.UnitTest.Printer
{
    [TestFixture]
    public class PrinterPortReaderTest
    {
        ...
        {
            CreateWorkingPortRegistryKey(description:null);
        ...
        {
            CreateWorkingPortRegistryKey(description: "My specific description");
