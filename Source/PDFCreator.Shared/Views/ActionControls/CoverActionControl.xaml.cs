...
namespace pdfforge.PDFCreator.Shared.Views.ActionControls
{
    public partial class CoverActionControl : ActionControl
    {
        public CoverActionControl()
        {
            ...
            DisplayName = TranslationHelper.Instance.TranslatorInstance.GetTranslation("CoverSettings", "DisplayName", "Add cover");
            Description = TranslationHelper.Instance.TranslatorInstance.GetTranslation("CoverSettings", "Description", "Add a cover to your documents.\r\nThe cover file must be a PDF file and may contain multiple pages.");
        ...
        {
            var title = TranslationHelper.Instance.TranslatorInstance.GetTranslation("CoverSettings", "SelectCoverFile", "Select cover file");
            var filter = TranslationHelper.Instance.TranslatorInstance.GetTranslation("CoverSettings", "PDFFiles", "PDF files")
                                    + @" (*.pdf)|*.pdf|"
