...
namespace pdfforge.PDFCreator.Shared.Views.UserControls
{
    public partial class PdfTab : UserControl
    {
        ...
        private void CertificationFileButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            var filter = TranslationHelper.TranslatorInstance.GetTranslation("ProfileSettingsWindow", "PfxP12Files", "PFX/P12 files")
                         + @" (*.pfx, *.p12)|*.pfx;*.p12|"
        ...
        private void SignaturePasswordButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                var message = TranslationHelper.TranslatorInstance.GetTranslation("ProfileSettingsWindow", "CertificateDoesNotExist",
                    "The certificate file does not exist.");
                var caption = TranslationHelper.TranslatorInstance.GetTranslation("ProfileSettingsWindow", "PDFSignature",
                    "PDF Signature");
