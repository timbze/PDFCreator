...
namespace pdfforge.PDFCreator.Shared.Helper
{
    public static class TokenHelper
    {
        ...
        private static TokenReplacer CreateTokenReplacerWithPlaceHolders()
        {
            ...
            tr.AddToken(new StringToken("InputFilename", TranslationHelper.Instance.TranslatorInstance.GetTranslation("TokenPlaceHolders", "MyFileDocx", "MyFile.docx")));
            ...
            tr.AddToken(new ListToken("OutputFilenames",
                new[] {TranslationHelper.Instance.TranslatorInstance.GetTranslation("TokenPlaceHolders","OutputFilename", "OutputFilename.jpg")
                    , TranslationHelper.Instance.TranslatorInstance.GetTranslation("TokenPlaceHolders","OutputFilename2", "OutputFilename2.jpg")
                    , TranslationHelper.Instance.TranslatorInstance.GetTranslation("TokenPlaceHolders","OutputFilename3", "OutputFilename3.jpg")}));
            ...
            tr.AddToken(new StringToken("Title", TranslationHelper.Instance.TranslatorInstance.GetTranslation("TokenPlaceHolders", "TitleFromSettings", "Title from Settings")));
            tr.AddToken(new StringToken("PrintJobName", TranslationHelper.Instance.TranslatorInstance.GetTranslation("TokenPlaceHolders", "TitleFromPrintJob", "Title from Printjob")));
