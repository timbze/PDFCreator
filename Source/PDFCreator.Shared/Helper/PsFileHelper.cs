...
namespace pdfforge.PDFCreator.Shared.Helper
{
    ...
    {        
        ...
        public static string TransformToInfFile(string psFile, string spoolFolder, string printerName = "PDFCreator")
        {
        ...
        private static string CreateInfFile(string psFile, string jobFolder, string psFileInJobFolder, string printerName)
        {
            var psFilename = PathSafe.GetFileName(psFile);
