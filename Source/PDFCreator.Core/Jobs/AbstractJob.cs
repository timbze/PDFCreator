...
namespace pdfforge.PDFCreator.Core.Jobs
{
    ...
    public abstract class AbstractJob : IJob
    {
        ...
        protected AbstractJob(IJobInfo jobInfo, ConversionProfile profile, JobTranslations jobTranslations, IFile fileWrap, IDirectory directoryWrap)
        {
            FileWrap = fileWrap;
        ...
        /// </summary>
        public bool Success { get { return JobState == JobState.Succeeded; } }
        ...
        {
            var outputFilename = FileUtil.Instance.MakeValidFileName(TokenReplacer.ReplaceTokens(Profile.FileNameTemplate));
        ...
        protected bool CopyFileWithInteractiveOutputFilenameTemplateQuery(string tempOutputFile, string numWithDigits, string extension)
        {
            while(true)
            {
                lock (LockObject)
