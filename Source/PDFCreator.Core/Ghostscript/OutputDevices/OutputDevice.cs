...
namespace pdfforge.PDFCreator.Core.Ghostscript.OutputDevices
{
    ...
    public abstract class OutputDevice
    {
        ...
        public IList<string> GetGhostScriptParameters(GhostscriptVersion ghostscriptVersion)
        {
            ...
            {
                string[] args = FileUtil.Instance.CommandLineToArgs(Job.Profile.Ghostscript.AdditionalGsParameters);
            ...
            if (Job.Profile.Stamping.Enabled)
            {
                ...
                string stampFileName = PathSafe.Combine(Job.JobTempFolder,
            ...
            string pdfMarkFileName = PathSafe.Combine(Job.JobTempFolder, "metadata.mtd");
        ...
        public string[] GetValidExtensions(OutputFormat format)
        {
            ...
            switch (format)
            {
                ...
                default: validExtensions = new[] { "." + format.ToString().ToLowerInvariant() };
                    break;
            }
        ...
        public bool HasValidExtension(string filename, OutputFormat format)
        {
            ...
            string ext = PathSafe.GetExtension(filename).ToLowerInvariant();
