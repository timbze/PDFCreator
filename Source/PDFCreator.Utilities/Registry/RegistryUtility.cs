...
namespace pdfforge.PDFCreator.Utilities.Registry
{
    ...
    /// </summary>
    public class RegistryUtility : IRegistryUtility
    {
        /// <summary>
        ...
        {
            //Create new key
            IRegistryKey destinationKey = parentKey.CreateSubKey(newKeyName);

            //Open the sourceKey we are copying from
            IRegistryKey sourceKey = parentKey.OpenSubKey(keyNameToCopy);
