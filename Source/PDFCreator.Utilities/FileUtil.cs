    ...
    public class FileUtil
    {
        ...
        public string EllipsisForPath(string filePath, int length)
        {
            ...
            if (filePath.Length > length)
            {
                ...
                int remainingLength = length - path.Length - ellipsis.Length - ext.Length - 1; // substract -1 to account for the slash between path and filename
        ...
        public  string CalculateMd5(string path)
        {
            ...
            string md5 = BitConverter.ToString(md5Hash).Replace("-", "").ToLowerInvariant();
            return md5;
        }
