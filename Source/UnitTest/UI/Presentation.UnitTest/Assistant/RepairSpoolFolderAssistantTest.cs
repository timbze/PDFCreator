...
namespace Presentation.UnitTest.Assistant
{
    ...
    public class RepairSpoolFolderAssistantTest
    {
        ...
        private RepairSpoolFolderAssistant BuildRepairSpoolFolderAssistant()
        {
            ...
            assemblyHelper.GetAssemblyDirectory().Returns(AssemblyFolder);

            _file.Exists(RepairToolPath).Returns(true);

            return new RepairSpoolFolderAssistant(_interactionInvoker, new DesignTimeTranslationUpdater(), spoolFolderProvider,
