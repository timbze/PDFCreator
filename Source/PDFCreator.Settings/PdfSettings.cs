...
namespace pdfforge.PDFCreator.Core.Settings
{
	...
	public class PdfSettings {
		...
		public void ReadValues(Data data, string path)
		{
			...
			try { ViewerStartsOnPage = int.Parse(data.GetValue(@"" + path + @"ViewerStartsOnPage"), CultureInfo.InvariantCulture); } catch { ViewerStartsOnPage = 1;}
		}
		...
		public void StoreValues(Data data, string path)
		{
			...
			data.SetValue(@"" + path + @"ViewerStartsOnPage", ViewerStartsOnPage.ToString(CultureInfo.InvariantCulture));
		}
