...
namespace PDFCreator.Core.IntegrationTest
{
    ...
    internal class CompressionAndResolutionTest
    {
        ...
        public void CompressionZipFaxResample24Dpi()
        {
            ...
            Assert.AreEqual(289, testResultsSize[0], 30.0);
            Assert.AreEqual(1930, testResultsSize[1], 30.0);
            Assert.AreEqual(5548, testResultsSize[2], 30.0);
            Assert.AreEqual(634, testResultsSize[3], 30.0);
        }
        ...
        public void CompressionFactor25RunLengthResample24Dpi()
        {
            ...
            Assert.AreEqual(387, testResultsSize[1], 2.0);
            Assert.AreEqual(728, testResultsSize[2], 2.0);
