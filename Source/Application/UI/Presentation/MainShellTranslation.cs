...
namespace pdfforge.PDFCreator.UI.Presentation
{
    public class MainShellTranslation : ITranslatable
    {
        ...
        public string NoRssFeedAvailable = "No RSS Feed Available";
        public string UnableToReadRssFeed = "Unable to load the RSS feed. Please check your internet connection.";
