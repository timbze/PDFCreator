...
namespace pdfforge.PDFCreator.UI.Presentation.DesignTime
{
    ...
    {
        public DesignTimeConvertTabViewModel() : base(new DesignTimeTranslationUpdater(), new DesignTimeCurrentSettingsProvider())
        {
        }
    }
    ...
    {
        public DesignTimePngTabViewModel() : base(new DesignTimeTranslationUpdater(), new DesignTimeCurrentSettingsProvider())
        {
    ...
    {
        public DesignTimeConvertJpgViewModel() : base(new DesignTimeTranslationUpdater(), new DesignTimeCurrentSettingsProvider())
        {
    ...
    {
        public DesignTimeConvertTiffViewModel() : base(new DesignTimeTranslationUpdater(), new DesignTimeCurrentSettingsProvider())
        {
