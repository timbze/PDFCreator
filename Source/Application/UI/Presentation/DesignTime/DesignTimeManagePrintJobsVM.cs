...
namespace pdfforge.PDFCreator.UI.Presentation.DesignTime
{
    ...
    {
        public DesignTimeManagePrintJobsVm() : base(new DesignTimeJobInfoQueue(), new DesignTimeDragAndDropHandler(), new JobInfoManager(null), new DispatcherWrapper(), new DesignTimeTranslationUpdater())
        {
        }
    }
}
