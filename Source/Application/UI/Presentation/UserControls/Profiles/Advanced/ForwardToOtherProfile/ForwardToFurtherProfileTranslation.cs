...
namespace pdfforge.PDFCreator.UI.Presentation.UserControls.Profiles.Advanced.ForwardToOtherProfile
{
    public class ForwardToFurtherProfileTranslation : ITranslatable
    {
        ...
        public string TriggerAnotherConversionOfOriginalDocument { get; private set; } = "Trigger another conversion by forwarding the original source document to another profile, e.g. to convert to another output format.";
