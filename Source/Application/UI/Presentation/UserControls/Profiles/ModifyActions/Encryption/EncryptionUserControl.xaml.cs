...
{
    public partial class EncryptionUserControl : UserControl, IRegionMemberLifetime, IActionUserControl
    {
        public bool KeepAlive { get; } = true;

        public EncryptionUserControl(EncryptionUserControlViewModel viewModel)
        {
