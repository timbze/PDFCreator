...
namespace pdfforge.PDFCreator.UI.DesignTimeViewModels.Windows
{
    public class DesignTimeAboutWindowViewModel : AboutWindowViewModel
    {
        public DesignTimeAboutWindowViewModel() :
            base(new ProcessStarter(), new ApplicationNameProvider("PDFCreator"), new VersionHelper(new AssemblyHelper()), new DesignTimeUserGuideHelper(), new ButtonDisplayOptions(false, false))
        {
        }
    }
}