...
{
    public static class CustomBindingResolver
    {
        ...
        private static Assembly CurrentDomain_ResolveAssembly(object sender, ResolveEventArgs e)
        {
            ...
            if (requestAssemblyName.EndsWith(".resources"))
            {
                Logger.Trace("The resource assembly will be skipped: " + requestAssemblyName);
                return null;
            }
