...
namespace pdfforge.PDFCreator.ErrorReport.Sentry
{
    /// <summary>
    /// Taken from Sentry, as it unfortunately is internal and required for serialization
    /// </summary>
    internal class MainExceptionProcessor : ISentryEventExceptionProcessor
    {
        ...
        public MainExceptionProcessor(Func<ISentryStackTraceFactory> sentryStackTraceFactoryAccessor)
        {
